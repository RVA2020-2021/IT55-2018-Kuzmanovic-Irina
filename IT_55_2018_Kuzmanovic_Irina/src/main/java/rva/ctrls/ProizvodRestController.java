...
public class ProizvodRestController {
	...
	@ApiOperation(value="Vraca proizvod iz baze podataka cija je id vrednost prosledjena kao path varijabla")
	public Proizvod getProizvod(@PathVariable("id") Integer id) {
		return proizvodRepository.getOne(id);
	}
	
	@GetMapping("proizvodNaziv/{naziv}")
	@ApiOperation(value="Vraca kolekciju svih proizvoda iz baze podataka koji u nazivu sadrze string prosledjen kao path varijabla")
	...
	@PutMapping("proizvod")
	@ApiOperation(value="Modifikuje postojeci proizvod u bazu podataka")
	...
	@ApiOperation(value="Brise proizvod iz baze podataka ciji je id vrednost prosledjena kao path varijabla")
