...
ALTER TABLE stavka_racuna ADD CONSTRAINT fk_stavka_porudzbine_proizvod FOREIGN KEY(proizvod) REFERENCES proizvod(id);
ALTER TABLE stavka_racuna ADD CONSTRAINT fk_stavka_porudzbine_racun FOREIGN KEY(racun) REFERENCES racun(id);
